...
- [x] make package hard-fails on missing BPF objects; Linux-only; arch-specific (Day 15)
- [x] scripts/verify-release-archive.sh: validates binary ELF, 4 BPF objects, scripts, MANIFEST.txt (Day 15)
- [x] MANIFEST.txt in each archive: version, commit, arch, BPF target define, validated kernels, limitations (Day 15)
- [x] release-package.yml: amd64 (ubuntu-22.04) + arm64 (ubuntu-22.04-arm) build matrix (Day 15)
- [x] x86-smoke.yml restructured: unit-build + bpf-scenario + human-output jobs (Day 15)
- [x] human-output CI job: validates Verdict:/Evidence: sections in printHuman output (Day 15)
- [x] package-rc1 convenience target: VERSION=v0.1.0-rc1 make package (Day 15)
- [x] evidence/day-15-stale-object-integration.md (Day 15)
- [x] evidence/day-15-demo.md (Day 15)
